...
***
***
Сделаю пояснения по тому коду, который я тебе дал в прошлом ответе (SQL + Python). Сейчас я не могу заново смотреть источники в интернете, поэтому для ссылок укажу условные номера, а не реальные страницы.  
